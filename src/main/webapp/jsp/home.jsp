...
/* Hero Section */
.hero-section {
    background: linear-gradient(rgba(0, 0, 0, 0.45), rgba(0, 0, 0, 0.45)), url('${pageContext.request.contextPath}/images/banners/hero-banner.jpg');
...
<body>
    ...
    <header class="navbar">
        <div class="container nav-container">
            ...
            <div class="nav-search">
                ...
                <input type="text" id="restaurantSearch" placeholder="Search restaurants or cuisines...">
            </div>
    ...
    <main class="container page-wrapper">
        ...
        <section class="hero-section">
            <h1 class="headline-lg">Hey, <%= (loggedUser != null) ? loggedUser.getFullName() : "Cravings Lover" %>!</h1>
            <p class="body-lg">Hungry? Discover the best foods & drinks from top restaurants around you, delivered straight to your door.</p>
        </section>

        <!-- Categories Filter Pills -->
        <section>
            <h3 class="label-md" style="color: var(--color-on-surface-variant); text-transform: uppercase;">What's on your mind?</h3>
            <div class="categories-container">
                <button class="category-pill active" data-category="all">
                    <i class="fa fa-utensils"></i> All Restaurants
                </button>
                <button class="category-pill" data-category="pizzas">
                    <i class="fa fa-pizza-slice"></i> Pizzas
                </button>
                <button class="category-pill" data-category="burgers">
                    <i class="fa fa-hamburger"></i> Burgers
                </button>
                <button class="category-pill" data-category="biryani">
                    <i class="fa fa-bowl-rice"></i> Biryani
                </button>
                <button class="category-pill" data-category="desserts">
                    <i class="fa fa-ice-cream"></i> Desserts
                </button>
                <button class="category-pill" data-category="sides">
                    <i class="fa fa-cookie"></i> Sides & Snacks
                </button>
            </div>
        </section>
        ...
        <section style="margin-top: var(--space-md);">
            <div class="section-title">
                <h2 class="headline-md">Top Rated Restaurants</h2>
                <span class="label-sm" style="color: var(--color-on-surface-variant);"><%= (restaurants != null) ? restaurants.size() : 0 %> open outlets</span>
            </div>
            ...
            <div class="grid grid-3">
                <%
                    if (restaurants != null && !restaurants.isEmpty()) {
                        for (Restaurant restaurant : restaurants) {
                            // Map restaurant categories dynamically for filtering
                            String categories = "";
                            String nameLower = (restaurant.getRestaurantName() != null) ? restaurant.getRestaurantName().toLowerCase() : "";
                            if (nameLower.contains("pizza")) categories = "pizzas, sides";
                            else if (nameLower.contains("burger")) categories = "burgers, sides";
                            else if (nameLower.contains("biryani")) categories = "biryani, starters";
                            else if (nameLower.contains("sweet") || nameLower.contains("delight")) categories = "desserts";
                            else if (nameLower.contains("wok") || nameLower.contains("roll")) categories = "sides, mains";
                %>
                    <div class="restaurant-card js-restaurant-card" 
                         data-name="<%= restaurant.getRestaurantName() %>"
                         data-desc="<%= restaurant.getDescription() %>"
                         data-categories="<%= categories %>"
                         onclick="window.location.href='${pageContext.request.contextPath}/restaurant?restaurantId=<%= restaurant.getRestaurantId() %>'">
                        ...
                        <div class="restaurant-info">
                            <div style="display: flex; justify-content: space-between; align-items: center;">
                                ...
                                <span class="badge badge-rating">
                                    <i class="fa fa-star" style="color: #ffcc00;"></i> <%= restaurant.getRating() %>
                                </span>
                            </div>
                            ...
                            <div class="restaurant-meta">
                                <span class="badge badge-delivery">
                                    <i class="fa fa-clock"></i> <%= restaurant.getDeliveryTime() %> mins
                                </span>
                                <span class="label-sm" style="color: var(--color-secondary); font-weight: 600;">
                                    <i class="fa fa-motorcycle"></i> Free Delivery
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                %>
                    <div style="grid-column: 1 / -1; text-align: center; padding: var(--space-xl) 0;">
                        <i class="fa fa-store-slash" style="font-size: 48px; color: var(--color-outline-variant);"></i>
                        <p class="body-md" style="margin-top: 10px;">No active restaurants found. Please run schema.sql to seed records.</p>
                    </div>
                <%
                    }
                %>
