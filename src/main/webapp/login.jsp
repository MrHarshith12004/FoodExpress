    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="body-sm">Satisfy your cravings in just a few clicks.</p>
            </div>
            ...
            <!-- Success Notifications (e.g. Registered) -->
            <%
            ...
            %>
                <div class="alert alert-success">
                    ...
                    <div>Registration Successful! Please login below.</div>
                </div>
            <%
                }
            %>
            ...
            %>
                <div class="alert alert-success">
                    ...
                    <div>Logged out successfully. See you soon!</div>
                </div>
            <%
                }
            %>
            ...
            <form id="loginForm" action="${pageContext.request.contextPath}/login" method="post">
                ...
                <button type="submit" class="btn btn-primary btn-block">
                    Login <i class="fa fa-arrow-right-to-bracket"></i>
                </button>
            </form>
