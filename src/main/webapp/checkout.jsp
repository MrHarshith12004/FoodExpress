...
<body>
    ...
    <main class="container page-wrapper">
        <!-- Back Link -->
        <a href="${pageContext.request.contextPath}/cart" class="label-md" style="display: inline-flex; align-items: center; gap: var(--space-xs); margin-bottom: var(--space-sm); color: var(--color-primary); font-weight: 600;">
            <i class="fa fa-arrow-left"></i> Return to Basket
        </a>

        <h1 class="headline-lg" style="margin-bottom: var(--space-md); color: var(--color-on-surface);">Secure Checkout</h1>
            ...
            <div class="cart-grid">
                ...
                <div class="checkout-card">
                    <form id="checkoutForm" action="${pageContext.request.contextPath}/checkout" method="post">
                        ...
                        <h3 class="headline-md" style="margin-bottom: var(--space-sm); color: var(--color-primary);">1. Delivery Information</h3>
                        
                        <div class="form-group">
                            <label for="deliveryAddress">Delivery Address</label>
                            <textarea id="deliveryAddress" name="deliveryAddress" class="form-control" rows="3" placeholder="Enter complete delivery address..." required><%= (loggedUser != null) ? loggedUser.getAddress() : "" %></textarea>
                            <small style="color: var(--color-on-surface-variant); font-size: 12px; margin-top: 4px;">
                                Prefilled from your profile. You can modify this for this order.
                            </small>
                        </div>

                        <h3 class="headline-md" style="margin-top: var(--space-md); margin-bottom: var(--space-sm); color: var(--color-primary);">2. Select Payment Method</h3>
                        ...
                        <div class="payment-methods">
                            ...
                            <label class="payment-method-option selected">
                                ...
                                <div>
                                    <h4 class="label-md" style="font-weight: 600;"><i class="fa fa-hand-holding-dollar"></i> Cash on Delivery (COD)</h4>
                                    <p class="label-sm" style="color: var(--color-on-surface-variant); font-weight: 400; margin-top: 2px;">Pay with cash or scan QR code when your food arrives.</p>
                                </div>
                            </label>
                            ...
                            <label class="payment-method-option">
                                ...
                                <div>
                                    <h4 class="label-md" style="font-weight: 600;"><i class="fa fa-credit-card"></i> Credit or Debit Card</h4>
                                    <p class="label-sm" style="color: var(--color-on-surface-variant); font-weight: 400; margin-top: 2px;">Pay securely with Visa, Mastercard, RuPay, or Maestro.</p>
                                </div>
                            </label>
                            ...
                            <label class="payment-method-option">
                                ...
                                <div>
                                    <h4 class="label-md" style="font-weight: 600;"><i class="fa fa-mobile-screen-button"></i> UPI (GPay, PhonePe, Paytm)</h4>
                                    <p class="label-sm" style="color: var(--color-on-surface-variant); font-weight: 400; margin-top: 2px;">Pay instantly from your bank account using UPI ID.</p>
                                </div>
                            </label>
                        </div>

                        <button type="submit" class="btn btn-primary btn-block" style="margin-top: var(--space-md);">
                            Place Order (Rs. <%= cart.getGrandTotal() %>) <i class="fa fa-circle-check"></i>
                        </button>
                    </form>
                </div>
                ...
                <div class="summary-card">
                    ...
                    <div style="display: flex; flex-direction: column; gap: var(--space-sm); margin: var(--space-sm) 0; max-height: 250px; overflow-y: auto; padding-right: 4px;">
                        <%
                            for (CartItem item : cart.getItems()) {
                        ...
                        %>
                            <div style="display: flex; justify-content: space-between; font-size: 14px; gap: 8px;">
                                <div style="display: flex; gap: 8px;">
                                    <span style="font-weight: 600; color: var(--color-primary);">x<%= item.getQuantity() %></span>
                                    <span style="color: var(--color-on-surface);"><%= menu.getFoodName() %></span>
                                </div>
                                <span style="font-weight: 600; color: var(--color-on-surface-variant);">Rs. <%= item.getSubtotal() %></span>
                            </div>
                        <%
                            }
                        %>
        ...
        %>
            <div style="text-align: center; padding: var(--space-xl) 0;">
                <i class="fa fa-store" style="font-size: 48px; color: var(--color-outline-variant);"></i>
                <p class="body-md" style="margin-top: 10px;">Your cart is empty. Please add items to checkout.</p>
                <a href="${pageContext.request.contextPath}/home" class="btn btn-primary" style="margin-top: var(--space-sm);">Shop Now</a>
            </div>
        <%
            }
        %>
